...
2. la définition d'un [générateur de formes](../generator/intro.md), qui détermine à la fois la stratégie d'optimisation employée par le simulateur et la forme des configurations simulées ;
